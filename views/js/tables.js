			...
			return function (t, e, n) {
				if (e) c("div.dtr-modal-content").empty().append(n());
					...
					var a = function () {
						...
						r = c('<div class="dtr-modal"/>').append(c('<div class="dtr-modal-display"/>').append(c('<div class="dtr-modal-content"/>').append(n())).append(c('<div class="dtr-modal-close">×</div>').click(function () {
							a()
